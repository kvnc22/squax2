...
if (limit > 120) {
    ...
    message.channel.send(new Discord.RichEmbed().setDescription(`:onayland: Yavaş Mod  **${limit}** saniye olarak ayarlandı!`).setAuthor('Uygulanan Komut: Slowmode').setColor('RANDOM'));
